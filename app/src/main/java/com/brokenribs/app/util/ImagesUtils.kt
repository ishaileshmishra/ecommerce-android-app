...
class ImagesUtils {
    ...
    object getImages {
        ...
        fun getRecommendedUrl(): MutableList<String> {
            return arrayListOf(
        ...
        fun getVegs(): MutableList<String> {
            return arrayListOf(
        ...
        fun getNonVegs(): MutableList<String> {
        ...
        fun getChinese(): MutableList<String> {
            return arrayListOf(
                "https://static.pexels.com/photos/67442/pexels-photo-67442-medium.jpeg",
                "https://static.pexels.com/photos/159494/book-glasses-read-study-159494-medium.jpeg",
        ...
        fun getThais(): MutableList<String> {
        ...
        fun scrollImages(): ArrayList<String>{
            return arrayListOf("https://images.pexels.com/photos/2847037/pexels-photo-2847037.jpeg",
                "https://images.pexels.com/photos/2737022/pexels-photo-2737022.jpeg",
                "https://images.pexels.com/photos/2977304/pexels-photo-2977304.jpeg",
                "https://images.pexels.com/photos/2776911/pexels-photo-2776911.jpeg")
        }
        ...
        fun offerImages(): ArrayList<String>{
            return arrayListOf(
                "https://listingthemes.com/my_assets/2018/03/offer-banner.png",
                "https://listingthemes.com/my_assets/2018/03/offer-banner.png",
                "https://listingthemes.com/my_assets/2018/03/offer-banner.png"
            )
        }
