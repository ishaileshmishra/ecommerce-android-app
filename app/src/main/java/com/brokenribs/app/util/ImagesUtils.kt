...
class ImagesUtils {
    ...
    object getImageUrls {
        ...
        public fun getImageUrls(): Array<String> {
            ...
            return arrayOf(
                "https://images.pexels.com/photos/2847037/pexels-photo-2847037.jpeg",
                "https://images.pexels.com/photos/2737022/pexels-photo-2737022.jpeg",
                "https://images.pexels.com/photos/2977304/pexels-photo-2977304.jpeg",
                "https://images.pexels.com/photos/2776911/pexels-photo-2776911.jpeg",
                ...
                "https://images.pexels.com/photos/3060324/pexels-photo-3060324.jpeg",
                "https://images.pexels.com/photos/3050856/pexels-photo-3050856.jpeg",
                "https://images.pexels.com/photos/1831764/pexels-photo-1831764.jpeg",
                "https://images.pexels.com/photos/698485/pexels-photo-698485.jpeg",
                "https://images.pexels.com/photos/2987584/pexels-photo-2987584.jpeg"
...
//                "https://static.pexels.com/photos/7093/coffee-desk-notes-workspace-medium.jpg"
    ...
    private var wishlistImageUri = ArrayList<String>()
    private var cartListImageUri = ArrayList<String>()



    object offers{
        fun getOffersUrls(): Array<String> {
            return arrayOf(
...
//                "https://static.pexels.com/photos/106936/pexels-photo-106936-medium.jpeg"
    ...
    fun getHomeApplianceUrls(): Array<String> {
        return arrayOf(
            "https://static.pexels.com/photos/1778/numbers-time-watch-white-medium.jpg",
    ...
    fun getElectronicsUrls(): Array<String> {
        return arrayOf(
    ...
    fun getLifeStyleUrls(): Array<String> {
        return arrayOf(
    ...
    public fun addWishlistImageUri(wishlistImageUri: String) {
        this.wishlistImageUri.add(0, wishlistImageUri)
    }

    public fun removeWishlistImageUri(position: Int) {
        this.wishlistImageUri.removeAt(position)
    }

    public fun getWishlistImageUri(): ArrayList<String> {
        return this.wishlistImageUri
    }

    // Methods for Cart
    public fun addCartListImageUri(wishlistImageUri: String) {
        this.cartListImageUri.add(0, wishlistImageUri)
    }

    public fun removeCartListImageUri(position: Int) {
        this.cartListImageUri.removeAt(position)
    }

    public fun getCartListImageUri(): ArrayList<String> {
